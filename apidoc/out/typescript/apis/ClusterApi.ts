...
export class ClusterApi extends runtime.BaseAPI {
     ...
     * list all clusters
     */
    async listKubeClustersRaw(requestParameters: ListKubeClustersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<V1SimpleResponse>> {
        const queryParameters: any = {};
     ...
     * list all clusters
     */
    async listKubeClusters(requestParameters: ListKubeClustersRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1SimpleResponse> {
