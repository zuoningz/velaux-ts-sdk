...
export class TargetApi extends runtime.BaseAPI {
     ...
     * create Target
     */
    async createTargetRaw(requestParameters: CreateTargetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<V1SimpleResponse>> {
     ...
     * create Target
     */
    async createTarget(requestParameters: CreateTargetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1SimpleResponse> {
     ...
     * deletet Target
     */
    async deleteTargetRaw(requestParameters: DeleteTargetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<V1SimpleResponse>> {
     ...
     * deletet Target
     */
    async deleteTarget(requestParameters: DeleteTargetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1SimpleResponse> {
     ...
     * detail Target
     */
    async detailTargetRaw(requestParameters: DetailTargetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<V1SimpleResponse>> {
        if (requestParameters.targetName === null || requestParameters.targetName === undefined) {
     ...
     * detail Target
     */
    async detailTarget(requestParameters: DetailTargetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1SimpleResponse> {
     ...
     * list Target
     */
    async listTargetsRaw(requestParameters: ListTargetsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<V1SimpleResponse>> {
        const queryParameters: any = {};
     ...
     * list Target
     */
    async listTargets(requestParameters: ListTargetsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1SimpleResponse> {
     ...
     */
    async updateTargetRaw(requestParameters: UpdateTargetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<V1SimpleResponse>> {
        if (requestParameters.targetName === null || requestParameters.targetName === undefined) {
     ...
     * update application Target config
     */
    async updateTarget(requestParameters: UpdateTargetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1SimpleResponse> {
