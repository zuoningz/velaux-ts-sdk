...
export class DefinitionApi extends runtime.BaseAPI {
     ...
     * Detail a definition
     */
    async detailDefinitionRaw(requestParameters: DetailDefinitionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<V1SimpleResponse>> {
     ...
     * Detail a definition
     */
    async detailDefinition(requestParameters: DetailDefinitionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1SimpleResponse> {
     ...
     */
    async listDefinitionsRaw(requestParameters: ListDefinitionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<V1SimpleResponse>> {
     ...
     * list all definitions
     */
    async listDefinitions(requestParameters: ListDefinitionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1SimpleResponse> {
     ...
     */
    async updateDefinitionStatusRaw(requestParameters: UpdateDefinitionStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<V1SimpleResponse>> {
        if (requestParameters.definitionName === null || requestParameters.definitionName === undefined) {
     ...
     * Update the status for a definition
     */
    async updateDefinitionStatus(requestParameters: UpdateDefinitionStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1SimpleResponse> {
     ...
     */
    async updateUISchemaRaw(requestParameters: UpdateUISchemaRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<V1SimpleResponse>> {
        if (requestParameters.definitionName === null || requestParameters.definitionName === undefined) {
     ...
     * Update the UI schema for a definition
     */
    async updateUISchema(requestParameters: UpdateUISchemaRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1SimpleResponse> {
