...
exports.V1WorkflowStepBaseToJSON = exports.V1WorkflowStepBaseFromJSONTyped = exports.V1WorkflowStepBaseFromJSON = exports.instanceOfV1WorkflowStepBase = void 0;
 ...
 */
function instanceOfV1WorkflowStepBase(value) {
    var isInstance = true;
    isInstance = isInstance && "name" in value;
    isInstance = isInstance && "type" in value;
    return isInstance;
}
exports.instanceOfV1WorkflowStepBase = instanceOfV1WorkflowStepBase;
function V1WorkflowStepBaseFromJSON(json) {
    return V1WorkflowStepBaseFromJSONTyped(json, false);
}
exports.V1WorkflowStepBaseFromJSON = V1WorkflowStepBaseFromJSON;
function V1WorkflowStepBaseFromJSONTyped(json, ignoreDiscriminator) {
...
exports.V1WorkflowStepBaseFromJSONTyped = V1WorkflowStepBaseFromJSONTyped;
function V1WorkflowStepBaseToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
...
exports.V1WorkflowStepBaseToJSON = V1WorkflowStepBaseToJSON;
