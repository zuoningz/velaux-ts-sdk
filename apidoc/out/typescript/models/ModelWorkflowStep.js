...
exports.ModelWorkflowStepToJSON = exports.ModelWorkflowStepFromJSONTyped = exports.ModelWorkflowStepFromJSON = exports.instanceOfModelWorkflowStep = void 0;
var runtime_1 = require("../runtime");
var ModelWorkflowStepBase_1 = require("./ModelWorkflowStepBase");
 ...
 */
function instanceOfModelWorkflowStep(value) {
    var isInstance = true;
...
exports.instanceOfModelWorkflowStep = instanceOfModelWorkflowStep;
function ModelWorkflowStepFromJSON(json) {
    return ModelWorkflowStepFromJSONTyped(json, false);
}
exports.ModelWorkflowStepFromJSON = ModelWorkflowStepFromJSON;
function ModelWorkflowStepFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        ...
        'subSteps': !(0, runtime_1.exists)(json, 'subSteps') ? undefined : (json['subSteps'].map(ModelWorkflowStepBase_1.ModelWorkflowStepBaseFromJSON)),
        'timeout': !(0, runtime_1.exists)(json, 'timeout') ? undefined : json['timeout'],
        'type': json['type'],
    };
}
exports.ModelWorkflowStepFromJSONTyped = ModelWorkflowStepFromJSONTyped;
function ModelWorkflowStepToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'subSteps': value.subSteps === undefined ? undefined : (value.subSteps.map(ModelWorkflowStepBase_1.ModelWorkflowStepBaseToJSON)),
        'timeout': value.timeout,
        'type': value.type,
    };
}
exports.ModelWorkflowStepToJSON = ModelWorkflowStepToJSON;
